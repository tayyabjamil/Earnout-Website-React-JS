            ...
            <Row style={styles.card}>
              <Form style={{ backgroundColor: 'white', padding: 0 }}>
                <div style={styles.flexSpaceCol}>
                  <h5 style={{ textAlign: 'center', color: '#8b9dee', fontSize: 16 }}>Register Account</h5>
                  ...
                  <div onClick={() => this.validateForm()} style={styles.btn} type="submit">
                  ...
                  <Link to="/login" style={{ textDecoration: 'none' }}>
                    ...
                    <div onClick={() => this.props.history.push('/login')}
                      style={{ textAlign: 'center', color: '#8b9dee', fontSize: 12, marginTop: 10, }}>
                      Already have an account ?<span style={{ color: '#22114f' }}> Log In</span>

                    </div>
                  </Link>

                </div>
                <div style={{ height: 100, paddingLeft: '10%', paddingRight: '10%', backgroundColor: '#f2f2f2', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'row', justifyContent: 'space-between' }}>
...
const styles = {
  ...
  btn: {
    backgroundColor: '#0397ff', borderTopRightRadius: 12, borderBottomLeftRadius: 12, height: 40, display: 'flex', justifyContent: 'center', alignItems: 'center',
  },
  bottomView: {
